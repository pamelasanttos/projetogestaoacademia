...
public class CadastroTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textCPF = new javax.swing.JFormattedTextField(Mascara("###.###.###-##"));
        textEmail = new javax.swing.JTextField();
        textEmail.setForeground(java.awt.Color.gray);
        ...
        textCPF.setForeground(java.awt.Color.gray);
    ...
    private void textNomeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_textNomeFocusLost
        ...
        if (textNome.getText().isEmpty()) { 
            textNome.setText("Nome");
            textNome.setForeground(Color.GRAY);// volta placeholder }
        }else {
            textNome.setForeground(Color.BLACK);
        } 
    ...
    private void cadastrarUsuario() {
        ...
        var UsuarioInserir = new UsuarioInserirModel(nome, cpf, email, telefone, sexo + 1, dataNasc);
        
        usuarioDto.InserirUsuario(UsuarioInserir);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CadastroTela().setVisible(true));
    }
